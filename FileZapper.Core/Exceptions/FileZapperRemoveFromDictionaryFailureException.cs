...
namespace FileZapper.Core.Engine
{
    ...
    {
        protected const string MessageFormat = "Dictionary {0} unable to remove key '{1}'";

        public FileZapperRemoveFromDictionaryFailureException(string sDictionaryName, string sKey)
